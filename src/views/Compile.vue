<template>
  <el-card class="all">
    <div class="top">
      <div class="nus">
        <el-button type="danger" @click="blaack('/Publish')">返回</el-button>
        <el-button type="primary" @click="spread('/Publish')">分布</el-button>
      </div>
      <el-form class="nuw">
        <el-form
          :model="ruleForm"
...
export default {
  ...
  methods: {
    ...
    getData(){
      this.$axios.req('/article/article',{_id:this.$route.query.id})
      .then(res=>{
        this.ruleForm=res.data;
        this.ruleForm.data=this.$dajs(this.ruleForm.data).format("YYYY-MM-DD hh:mm:ss")
        console.log(res);
      }).catch(err=>{
        console.log(err);
      })
 ...
 spread(val) {
   this.$axios
        ...
        .req("/article/update", {
          _id: this.$route.ruleForm.id,
          title: this.$route.ruleForm.title,
          abstract: this.$route.ruleForm.abstract,

          author: this.$route.ruleForm.author,
          category: this.$route.ruleForm.category,
          source: this.$route.ruleForm.source,
          star: this.$route.ruleForm.star,
          text: this.$route.ruleForm.text,
             date: this.$route.ruleForm.date,
